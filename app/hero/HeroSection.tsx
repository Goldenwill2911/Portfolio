    ...
    >
      <div className="hero-layout">
        ...
        <div className="hero-headshot flex justify-center">
          <div className="relative aspect-square w-full max-w-[180px] overflow-hidden rounded-full border border-[color:var(--border)] bg-[color:var(--panel-strong)] shadow-[0_24px_50px_-42px_rgba(10,12,16,0.7)] sm:max-w-[220px] h-full w-full object-cover object-top">
            <Image
              src="/me/headshot2.jpg"
        ...
        <a
          ...
          aria-label="View GoldenWill2911 on GitHub"
        >
